...
This is a {"RETRACEMENT SHORT" if move['direction'] == 'bearish' else "RETRACEMENT LONG"} setup"""
    ...
    confluence_count = sum([has_divergence, has_absorption, has_climax, has_fib])
    ...
    if confluence_count >= 3:
        ...
        summary += "\n\n= <b>ULTRA HIGH CONVICTION SETUP!</b> 💎"
        summary += "\n\n🗣️ <b>In Plain English:</b>"
        summary += "\nMultiple signals aligning - this is a major setup!"
...
def home():
    return f"""
    <h1>🚀 Beast Mode V7 - CLEAN EDITION</h1>
    ...
    <ul>
        ...
        <li>✅ Confluence Detection (patterns + fibs)</li>
    ...
    <ul>
        ...
        <li>🟡 MEXC: $12B daily (FIXED!)</li>
        <li>🔵 KuCoin: $12B daily</li>
        <li>🔷 Gate.io: $10B daily</li>
    </ul>
    <p><b>Total: $71B daily (47% coverage)</b></p>
    """, 200

if __name__ == '__main__':
    print("🚀 Beast Mode V7 - CLEAN EDITION")
    print("="*80)
    ...
    send_telegram(f"""
🚀 <b>Beast Mode V7 - CLEAN Started!</b>
...
<b>💡 UNIFIED UPDATES:</b>
One clean message every 15 min
No more spam - just complete context!

<b>Coverage: $71B daily (47%)</b>
🟠 OKX • 🟢 Bitget • 🟡 MEXC • 🔵 KuCoin • 🔷 Gate.io
