...
Multi-timeframe alignment = HIGH conviction
{perf_info}

<b>🗣️ IN PLAIN ENGLISH:</b>
Price keeps hitting higher prices, but each time buyers are getting weaker. This means sellers are absorbing all the buying pressure and preparing to dump. When multiple timeframes show this pattern, it's a major warning sign that the top is in. {"This pattern has worked " + str(int(win_rate)) + "% of the time historically." if perf_info else ""}
"""
...
Expect upside continuation
Multi-timeframe alignment = HIGH conviction
{perf_info}

<b>🗣️ IN PLAIN ENGLISH:</b>
Price keeps dropping to lower prices, but each time sellers are getting weaker. This means buyers are absorbing all the selling pressure and preparing to pump. When multiple timeframes show this pattern, it's a major sign that the bottom is in. {"This pattern has worked " + str(int(win_rate)) + "% of the time historically." if perf_info else ""}
"""
...
<i>Alerts sent when patterns detected</i>
    """)
