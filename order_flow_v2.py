...
if __name__ == '__main__':
    ...
    print("="*80)
    print("🆕 ENTRY TRIGGER SYSTEM:")
    print("  ✅ Accumulation/Distribution detected → zone saved")
    print("  ✅ Zone watches for: price breakout + delta confirm + CVD momentum")
    print("  ✅ Entry alert fires when ALL 3 conditions met")
    print("  ✅ Includes stop loss, target, R:R, and position size")
    print(f"  ✅ Mode: {'📋 PAPER TRADING' if PAPER_TRADING else '🔴 LIVE'}")
    print("="*80)
    print("🔍 ENTRY LOGIC:")
    print("  • LONG: Price breaks zone high + positive delta + bullish CVD")
    print("  • SHORT: Price breaks zone low + negative delta + bearish CVD")
    print("  • Zones expire after 4 hours if not triggered")
    print("  • 1 hour cooldown between same-direction entries")
    print("="*80)
    print("📋 USAGE: Call check_entry_triggers() in your main 15min loop")
    print("         alongside detect_absorption_patterns()")
    print("="*80)
    print("Ready to detect AND enter!")
