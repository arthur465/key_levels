...
"""
                ...
                # Adjust conviction based on structure alignment
...
def home():
    ...
    <ul>
        ...
        <li>🆕 Structure + Orderflow Alignment (institutional-grade)</li>
...
if __name__ == '__main__':
    ...
    print("  • STRUCTURE CONTEXT section (NEW!)")
...
• Divergences (with structure context!)
...
<i>Alerts sent when patterns detected with full structure context</i>
    """)
