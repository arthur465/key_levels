...
def home():
    ...
    <ul>
        <li>Binance Book: {'✅ ' + working_endpoints.get('binance_orderbook', '❌ None')}</li>
        <li>Binance Trades: {'✅ ' + working_endpoints.get('binance_trades', '❌ None')}</li>
        <li>Bybit Book: {'✅ ' + working_endpoints.get('bybit_orderbook', '❌ None')}</li>
        <li>Bybit Trades: {'✅ ' + working_endpoints.get('bybit_trades', '❌ None')}</li>
    </ul>
    """, 200
